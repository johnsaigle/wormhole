...
type GossipMessage struct {
	...
	//	*GossipMessage_SignedObservationBatch
	//	*GossipMessage_SignedNotaryStatus
...
func (x *GossipMessage) GetSignedObservationBatch() *SignedObservationBatch {
	if x, ok := x.GetMessage().(*GossipMessage_SignedObservationBatch); ok {
		return x.SignedObservationBatch
	}
	return nil
}

func (x *GossipMessage) GetSignedNotaryStatus() *SignedNotaryStatus {
	if x, ok := x.GetMessage().(*GossipMessage_SignedNotaryStatus); ok {
		return x.SignedNotaryStatus
	}
	return nil
}
...
type GossipMessage_SignedNotaryStatus struct {
	SignedNotaryStatus *SignedNotaryStatus `protobuf:"bytes,13,opt,name=signed_notary_status,json=signedNotaryStatus,proto3,oneof"`
}
...
func (*GossipMessage_SignedObservationBatch) isGossipMessage_Message() {}

func (*GossipMessage_SignedNotaryStatus) isGossipMessage_Message() {}
...
func (x *ObservationRequest) GetTimestamp() int64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
type ChainGovernorConfig struct {
	...
	FlowCancelEnabled bool                         `protobuf:"varint,6,opt,name=flow_cancel_enabled,json=flowCancelEnabled,proto3" json:"flow_cancel_enabled,omitempty"`
}
...
// This message is published every minute.
type SignedNotaryStatus struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Serialized NotaryStatus message.
	Status []byte `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"`
	// ECDSA signature using the node's guardian key.
	Signature []byte `protobuf:"bytes,2,opt,name=signature,proto3" json:"signature,omitempty"`
	// Guardian address that signed this payload (truncated Eth address).
...
func (x *SignedNotaryStatus) Reset() {
	*x = SignedNotaryStatus{}
	if protoimpl.UnsafeEnabled {
...
func (x *SignedNotaryStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SignedNotaryStatus) ProtoMessage() {}

func (x *SignedNotaryStatus) ProtoReflect() protoreflect.Message {
	mi := &file_gossip_v1_gossip_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SignedNotaryStatus.ProtoReflect.Descriptor instead.
func (*SignedNotaryStatus) Descriptor() ([]byte, []int) {
	return file_gossip_v1_gossip_proto_rawDescGZIP(), []int{10}
}

func (x *SignedNotaryStatus) GetStatus() []byte {
	if x != nil {
		return x.Status
	}
	return nil
...
func (x *SignedNotaryStatus) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
func (x *SignedNotaryStatus) GetGuardianAddr() []byte {
	if x != nil {
		return x.GuardianAddr
	}
	return nil
...
type NotaryStatus struct {
	...
	Counter         int64                          `protobuf:"varint,2,opt,name=counter,proto3" json:"counter,omitempty"`
	Timestamp       int64                          `protobuf:"varint,3,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
	TotalDelayed    uint64                         `protobuf:"varint,4,opt,name=total_delayed,json=totalDelayed,proto3" json:"total_delayed,omitempty"`
	TotalBlackholed uint64                         `protobuf:"varint,5,opt,name=total_blackholed,json=totalBlackholed,proto3" json:"total_blackholed,omitempty"`
	DelayedMessages []*NotaryStatus_DelayedMessage `protobuf:"bytes,6,rep,name=delayed_messages,json=delayedMessages,proto3" json:"delayed_messages,omitempty"` // Only the first 20 will be included.
}

func (x *NotaryStatus) Reset() {
	*x = NotaryStatus{}
	if protoimpl.UnsafeEnabled {
...
func (x *NotaryStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NotaryStatus) ProtoMessage() {}

func (x *NotaryStatus) ProtoReflect() protoreflect.Message {
	mi := &file_gossip_v1_gossip_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NotaryStatus.ProtoReflect.Descriptor instead.
func (*NotaryStatus) Descriptor() ([]byte, []int) {
	return file_gossip_v1_gossip_proto_rawDescGZIP(), []int{11}
}

func (x *NotaryStatus) GetNodeName() string {
	if x != nil {
		return x.NodeName
	}
	return ""
...
func (x *NotaryStatus) GetCounter() int64 {
	if x != nil {
		return x.Counter
	}
	return 0
...
func (x *NotaryStatus) GetTimestamp() int64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
func (x *NotaryStatus) GetTotalDelayed() uint64 {
	if x != nil {
		return x.TotalDelayed
	}
	return 0
}

func (x *NotaryStatus) GetTotalBlackholed() uint64 {
	if x != nil {
		return x.TotalBlackholed
	}
	return 0
}

func (x *NotaryStatus) GetDelayedMessages() []*NotaryStatus_DelayedMessage {
	if x != nil {
		return x.DelayedMessages
	}
	return nil
}
...
type SignedObservationBatch struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (*ChainGovernorConfig_Chain) Descriptor() ([]byte, []int) {
	return file_gossip_v1_gossip_proto_rawDescGZIP(), []int{7, 0}
}
...
func (*ChainGovernorConfig_Token) Descriptor() ([]byte, []int) {
	return file_gossip_v1_gossip_proto_rawDescGZIP(), []int{7, 1}
}
...
func (*ChainGovernorStatus_EnqueuedVAA) Descriptor() ([]byte, []int) {
	return file_gossip_v1_gossip_proto_rawDescGZIP(), []int{9, 0}
}
...
func (*ChainGovernorStatus_Emitter) Descriptor() ([]byte, []int) {
	return file_gossip_v1_gossip_proto_rawDescGZIP(), []int{9, 1}
}
...
type ChainGovernorStatus_Chain struct {
	...
	SmallTxNetNotionalValue      int64                          `protobuf:"varint,4,opt,name=small_tx_net_notional_value,json=smallTxNetNotionalValue,proto3" json:"small_tx_net_notional_value,omitempty"`
	SmallTxOutgoingNotionalValue uint64                         `protobuf:"varint,5,opt,name=small_tx_outgoing_notional_value,json=smallTxOutgoingNotionalValue,proto3" json:"small_tx_outgoing_notional_value,omitempty"`
	FlowCancelNotionalValue      uint64                         `protobuf:"varint,6,opt,name=flow_cancel_notional_value,json=flowCancelNotionalValue,proto3" json:"flow_cancel_notional_value,omitempty"`
}
...
func (*ChainGovernorStatus_Chain) Descriptor() ([]byte, []int) {
	return file_gossip_v1_gossip_proto_rawDescGZIP(), []int{9, 2}
}
...
func (x *ChainGovernorStatus_Chain) GetSmallTxNetNotionalValue() int64 {
	if x != nil {
		return x.SmallTxNetNotionalValue
	}
	return 0
}
...
func (x *ChainGovernorStatus_Chain) GetSmallTxOutgoingNotionalValue() uint64 {
	if x != nil {
		return x.SmallTxOutgoingNotionalValue
	}
	return 0
}
...
func (x *ChainGovernorStatus_Chain) GetFlowCancelNotionalValue() uint64 {
	if x != nil {
		return x.FlowCancelNotionalValue
	}
	return 0
}

type NotaryStatus_DelayedMessage struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	EmitterChain   uint32 `protobuf:"varint,1,opt,name=emitter_chain,json=emitterChain,proto3" json:"emitter_chain,omitempty"`
	EmitterAddress []byte `protobuf:"bytes,2,opt,name=emitter_address,json=emitterAddress,proto3" json:"emitter_address,omitempty"`
...
func (x *NotaryStatus_DelayedMessage) Reset() {
	*x = NotaryStatus_DelayedMessage{}
	if protoimpl.UnsafeEnabled {
...
func (x *NotaryStatus_DelayedMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NotaryStatus_DelayedMessage) ProtoMessage() {}

func (x *NotaryStatus_DelayedMessage) ProtoReflect() protoreflect.Message {
	mi := &file_gossip_v1_gossip_proto_msgTypes[22]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NotaryStatus_DelayedMessage.ProtoReflect.Descriptor instead.
func (*NotaryStatus_DelayedMessage) Descriptor() ([]byte, []int) {
	return file_gossip_v1_gossip_proto_rawDescGZIP(), []int{11, 0}
}

func (x *NotaryStatus_DelayedMessage) GetEmitterChain() uint32 {
	if x != nil {
...
func (x *NotaryStatus_DelayedMessage) GetEmitterAddress() []byte {
	if x != nil {
		return x.EmitterAddress
	}
	return nil
...
func (x *NotaryStatus_DelayedMessage) GetSequence() uint64 {
	if x != nil {
		return x.Sequence
	}
	return 0
...
func (x *NotaryStatus_DelayedMessage) GetReleaseTime() uint32 {
	if x != nil {
		return x.ReleaseTime
	}
	return 0
...
func (x *NotaryStatus_DelayedMessage) GetTxHash() string {
	if x != nil {
		return x.TxHash
	}
	return ""
...
var file_gossip_v1_gossip_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x03, 0x52, 0x06, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x29, 0x0a, 0x10, 0x63, 0x6f, 0x6e,
	...
	,
	...
	0x75, 0x61, 0x72, 0x64, 0x69, 0x61, 0x6e, 0x41, 0x64, 0x64, 0x72, 0x22, 0x66, 0x0a, 0x12, 0x4f,
	...
	0x78, 0x48, 0x61, 0x73, 0x68, 0x12, 0x1c, 0x0a, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61,
	0x6d, 0x70, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74,
	0x61, 0x6d, 0x70, 0x22, 0x76, 0x0a, 0x19, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x43, 0x68, 0x61,
	...
	0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x67, 0x75, 0x61, 0x72, 0x64, 0x69,
	0x61, 0x6e, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0c, 0x67,
	0x75, 0x61, 0x72, 0x64, 0x69, 0x61, 0x6e, 0x41, 0x64, 0x64, 0x72, 0x22, 0x81, 0x04, 0x0a, 0x13,
	0x43, 0x68, 0x61, 0x69, 0x6e, 0x47, 0x6f, 0x76, 0x65, 0x72, 0x6e, 0x6f, 0x72, 0x43, 0x6f, 0x6e,
	...
	0x6b, 0x65, 0x6e, 0x73, 0x12, 0x2e, 0x0a, 0x13, 0x66, 0x6c, 0x6f, 0x77, 0x5f, 0x63, 0x61, 0x6e,
	0x63, 0x65, 0x6c, 0x5f, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x11, 0x66, 0x6c, 0x6f, 0x77, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x45, 0x6e, 0x61,
	0x62, 0x6c, 0x65, 0x64, 0x1a, 0x7b, 0x0a, 0x05, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x12, 0x19, 0x0a,
	...
	0x69, 0x61, 0x6e, 0x41, 0x64, 0x64, 0x72, 0x22, 0xdb, 0x06, 0x0a, 0x13, 0x43, 0x68, 0x61, 0x69,
	...
	0x75, 0x65, 0x64, 0x56, 0x61, 0x61, 0x73, 0x1a, 0xeb, 0x02, 0x0a, 0x05, 0x43, 0x68, 0x61, 0x69,
	...
	,
	...
	0x65, 0x12, 0x23, 0x0a, 0x0d, 0x67, 0x75, 0x61, 0x72, 0x64, 0x69, 0x61, 0x6e, 0x5f, 0x61, 0x64,
	0x64, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0c, 0x67, 0x75, 0x61, 0x72, 0x64, 0x69,
	0x61, 0x6e, 0x41, 0x64, 0x64, 0x72, 0x22, 0xbf, 0x03, 0x0a, 0x0c, 0x4e, 0x6f, 0x74, 0x61, 0x72,
	0x79, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x6e, 0x6f, 0x64, 0x65, 0x5f,
	...
	,
	...
	,
	...
	,
...
var file_gossip_v1_gossip_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_gossip_v1_gossip_proto_goTypes = []interface{}{
	...
	(*SignedVAAWithQuorum)(nil),             // 3: gossip.v1.SignedVAAWithQuorum
	(*SignedObservationRequest)(nil),        // 4: gossip.v1.SignedObservationRequest
	(*ObservationRequest)(nil),              // 5: gossip.v1.ObservationRequest
	(*SignedChainGovernorConfig)(nil),       // 6: gossip.v1.SignedChainGovernorConfig
	(*ChainGovernorConfig)(nil),             // 7: gossip.v1.ChainGovernorConfig
	(*SignedChainGovernorStatus)(nil),       // 8: gossip.v1.SignedChainGovernorStatus
	(*ChainGovernorStatus)(nil),             // 9: gossip.v1.ChainGovernorStatus
	(*SignedNotaryStatus)(nil),              // 10: gossip.v1.SignedNotaryStatus
	(*NotaryStatus)(nil),                    // 11: gossip.v1.NotaryStatus
	(*SignedQueryRequest)(nil),              // 12: gossip.v1.SignedQueryRequest
	(*SignedQueryResponse)(nil),             // 13: gossip.v1.SignedQueryResponse
	(*SignedObservationBatch)(nil),          // 14: gossip.v1.SignedObservationBatch
	(*Observation)(nil),                     // 15: gossip.v1.Observation
	...
	(*NotaryStatus_DelayedMessage)(nil),     // 22: gossip.v1.NotaryStatus.DelayedMessage
}
var file_gossip_v1_gossip_proto_depIdxs = []int32{
	...
	3,  // 1: gossip.v1.GossipMessage.signed_vaa_with_quorum:type_name -> gossip.v1.SignedVAAWithQuorum
	4,  // 2: gossip.v1.GossipMessage.signed_observation_request:type_name -> gossip.v1.SignedObservationRequest
	6,  // 3: gossip.v1.GossipMessage.signed_chain_governor_config:type_name -> gossip.v1.SignedChainGovernorConfig
	8,  // 4: gossip.v1.GossipMessage.signed_chain_governor_status:type_name -> gossip.v1.SignedChainGovernorStatus
	12, // 5: gossip.v1.GossipMessage.signed_query_request:type_name -> gossip.v1.SignedQueryRequest
	13, // 6: gossip.v1.GossipMessage.signed_query_response:type_name -> gossip.v1.SignedQueryResponse
	14, // 7: gossip.v1.GossipMessage.signed_observation_batch:type_name -> gossip.v1.SignedObservationBatch
	10, // 8: gossip.v1.GossipMessage.signed_notary_status:type_name -> gossip.v1.SignedNotaryStatus
	...
	22, // 13: gossip.v1.NotaryStatus.delayed_messages:type_name -> gossip.v1.NotaryStatus.DelayedMessage
	15, // 14: gossip.v1.SignedObservationBatch.observations:type_name -> gossip.v1.Observation
	19, // 15: gossip.v1.ChainGovernorStatus.Emitter.enqueued_vaas:type_name -> gossip.v1.ChainGovernorStatus.EnqueuedVAA
	20, // 16: gossip.v1.ChainGovernorStatus.Chain.emitters:type_name -> gossip.v1.ChainGovernorStatus.Emitter
...
func file_gossip_v1_gossip_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_gossip_v1_gossip_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SignedNotaryStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_gossip_v1_gossip_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SignedObservationBatch); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_gossip_v1_gossip_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NotaryStatus_DelayedMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_gossip_v1_gossip_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*GossipMessage_SignedObservationBatch)(nil),
		(*GossipMessage_SignedNotaryStatus)(nil),
	}
	type x struct{}
